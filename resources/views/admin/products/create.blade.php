        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body">
                    ...
                    <form action="https://smashinit.co.uk/admin/item/save" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="MsM4KXUHMSplpoNvWlR7y2GMUYdwU6HbY0FIwZpW">
                        <div class="row mt-3">
                            ...
                            <div class="col-6 form-group">
                                ...
                                <input type="text" id="title" name="title" class="form-control form-control-lg"
                                    placeholder="Item Title" value="" required>
                            </div>
                            ...
                            <div class="row mt-5" id="category_as_extra_section" style="display:none;">
                                ...
                                <div class="col-4 form-group mt-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg"
                                        name="category_as_extra_order[]" value="">
                                </div>
                                <div class="col-4 form-group mt-3">
                                    <label for="Name"> Item Category:</label>
                            ...
                            <div class="row mt-5" id="manual_extra_section"
                                ...
                                <div class="row mb-3" id="manual_extra_section_row_0">
                                    ...
                                    <div class="col-2 form-group mt-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg"
                                            name="manual_extra_section_order[]" value="">
                                    </div>
                                    <div class="col-6 form-group mt-3">
                                        <label for="Name"> Extra Section Title:</label>
                                        <input type="text" class="form-control form-control-lg"
                                            name="manual_extra_section_title[]" value="">
                                    </div>
                                    <div class="col-4 form-group mt-3">
                                        <label for="Name">Extra Type:</label>
                                        <select name="manual_extra_type[]" class="form-control form-control-lg"
                                            id="">
                                            <option value="1">Radio: Select only one extra from list</option>
                                            <option value="2">CheckBox: Select multiple extras from list</option>
                                        </select>
                                    ...
                                    <div class="row" id="item_row_0">
                                        ...
                                        <div class="col-3 form-group mt-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                name="manual_extra_title[0][]" value="">
                                        </div>
                                        <div class="col-3 form-group mt-3">
                                            <label for="Name">Extra Item Price:</label>
                                            <input type="text" class="form-control form-control-lg"
                                                name="manual_extra_price[0][]" value="">
                                        </div>
                                        <div class="col-4 form-group mt-3">
                                            <label for="Name">Extra Item Image:</label>
                                            <input type="file" class="form-control form-control-lg"
                                                name="manual_extra_image[0][]" value="">
                                        </div>
                                ...
                                <div class="form-group mt-3 col-6">
                                    <button type="button" class="btn btn-sm btn-success"
                                        onclick="add_new_extra_item(0)">Add new extra item</button>
                                </div>
                            </div>


                            <div class="col-12 mt-3 text-center">
                                <button class="btn btn-success" type="button" onclick="add_separate_extra()">Add
                                    Separate Extras</button>
                                <button class="btn btn-success" type="button" onclick="add_category_as_extra()">Use
    ...
    <script>
        ...
        function add_separate_extra() {
            ...
            <div class="row mb-3" id="manual_extra_section_row_` + (separate_extra) + `">
                    ...
                    separate_extra) + `][]" value="0">
                        <div class="col-3 form-group mt-3">
                            <label for="Name">Extra Item Title:</label>
                            <input type="text" class="form-control form-control-lg" name="manual_extra_title[` + (
                    separate_extra) + `][]" value="">
                        </div>
                        <div class="col-3 form-group mt-3">
                            <label for="Name">Extra Item Price:</label>
                            <input type="text" class="form-control form-control-lg" name="manual_extra_price[` + (
                    separate_extra) + `][]" value="">
                        </div>
                        <div class="col-4 form-group mt-3">
                            <label for="Name">Extra Item Image:</label>
                            <input type="file" class="form-control form-control-lg" name="manual_extra_image[` + (
                    separate_extra) + `][]" value="">
                        </div>
                        <div class="col-2 form-group mt-3" style="padding-top: 25px;">
                            <button type="button" class="btn btn-lg btn-danger" onclick="delete_item_row(` + (
                ...
                <div class="form-group mt-3 col-6">
                    <button type="button" class="btn btn-sm btn-success" onclick="add_new_extra_item(` + (
        ...
        function add_new_extra_item(row) {
            ...
            <div class="row" id="item_row_` + (row) + `">
                ...
                <div class="col-2 form-group mt-3" style="padding-top: 25px;">
                    <button type="button" class="btn btn-lg btn-danger" onclick="delete_item_row(` + (row) + `,` + (
                    row + 1) + `)">Delete</button>
                </div>
            </div>`
            )
